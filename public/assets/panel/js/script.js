...
(function ($) {
  ...
  var trans = [
    ...
    {
      en: "Dashboards,Veranstaltungen & layout.",

      pt: "PainÃ©is, Veranstaltungen e layout.",
      es: "Paneloj, fenestraÄµoj kaj aranÄo.",
      fr: "Tableaux de bord, Veranstaltungen et mise en page.",
      de: "Dashboards, Veranstaltungen en lay-out.",
